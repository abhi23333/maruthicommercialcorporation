...
const pillars = [
  ...
  },
  {
    ...
    body: 'Providing reliable transportation and logistics solutions for the movement of goods, connecting suppliers, businesses and markets through an efficient transport network.',
  },
  {
    n: '03',
      ...
      <div className="mx-auto max-w-7xl px-5 md:px-8">
        <Reveal className="max-w-3xl">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-relaxed text-muted-foreground">
            MCC works across a spectrum of commercial activity, from trading
            and transportation to logistics, deal origination, partnerships
            and diversified ventures — an approach that keeps us responsive to
        ...
        <div className="mt-16 grid gap-6 md:grid-cols-2">
          {pillars.map((p, i) => (
            <Reveal
              key={p.n}
              delay={(i % 2) * 120}
              className={i === pillars.length - 1 ? 'md:col-span-2' : ''}
            >
